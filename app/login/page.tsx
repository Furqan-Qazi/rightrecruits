...
>>>>>>> 38c74c80e20701ebdc27a9123f95fd00f870e250

// Optional: replace with your button component
const CustomButton = ({
  text,
  className,
}: {
...
<<<<<<< HEAD
  ...
  return (
    <>
      ...
      <section className="min-h-screen flex flex-col bg-gradient-to-b from-lime-500 to-lime-900 pt-32">
